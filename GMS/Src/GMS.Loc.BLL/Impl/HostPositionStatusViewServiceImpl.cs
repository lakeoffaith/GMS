...
{
    public class HostPositionStatusViewServiceImpl : BaseLocServiceImpl<HostPositionStatusView>, IHostPositionStatusViewService
    {
        public DataTablesResult<HostPositionStatusView> JsonForDT(Contract.request.HostRequestForDT request)
        {
            ...
            return new DataTablesResult<HostPositionStatusView>(request.sEcho, data.Count(), data.Count(), data.ToList<HostPositionStatusView>());
